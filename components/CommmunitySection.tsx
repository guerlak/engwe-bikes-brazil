            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4 mt-8">
                <div className="aspect-[3/4] bg-zinc-100 rounded-2xl overflow-hidden relative group">
                  ...
                  <Image 
                    src="https://picsum.photos/seed/bike1/400/600" 
                    alt="Lifestyle 1" 
                    fill
                ...
                <div className="aspect-square bg-zinc-100 rounded-2xl overflow-hidden relative group">
                   <Image 
                     src="https://picsum.photos/seed/bike2/400/400" 
                     alt="Lifestyle 2" 
                     fill
                     className="object-cover group-hover:scale-110 transition-transform duration-700"
                   />
              ...
              <div className="space-y-4">
                <div className="aspect-square bg-zinc-100 rounded-2xl overflow-hidden relative group">
                   <Image 
                     src="https://picsum.photos/seed/bike3/400/400" 
                     alt="Lifestyle 3" 
                     fill
                     className="object-cover group-hover:scale-110 transition-transform duration-700"
                   />
                ...
                <div className="aspect-[3/4] bg-zinc-100 rounded-2xl overflow-hidden relative group">
                   <Image 
                     src="https://picsum.photos/seed/bike4/400/600" 
                     alt="Lifestyle 4" 
                     fill
                     className="object-cover group-hover:scale-110 transition-transform duration-700"
                   />
